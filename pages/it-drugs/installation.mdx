...
## Asset dependencies
| Scripts | REQUIRED VERSION | Download |
| --- | ---  | --- |
| ox_lib | **Minimal:** `3.25.0` **Recommended:** `latest` | https://github.com/overextended/ox_lib/releases |
| oxmysql | **Minimal:** `latest` **Recommended:** `latest` | https://github.com/overextended/oxmysql |
| it_bridge | **Minimal:** `1.0.1` **Recommended:** `latest` | https://it-scripts.tebex.io/package/6706602 |
| **Target System*** |  |
| ESX (ox_target) | **Minimal:** `latest` **Recommended:** `latest` | https://github.com/overextended/ox_target |
| QbCore (qb-target) | **Minimal:** `latest` **Recommended:** `latest` | https://github.com/qbcore-framework/qb-target |
* You do not need to install a target system if you are using the script without the target system.
<Callout type="error">
...
<AccordionGroup>
  <Accordion title="Basic framework configuration">
    The asset will work automatically if your framework is supported by the asset. If you have a modified framework please contact the support team or a developer to help you.
  </Accordion>
