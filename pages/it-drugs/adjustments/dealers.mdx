---
title: it-drugs - Dealers
description: The dealer was added to it-drugs with version v1.2.4 and could sell items, with version v1.3.0 the dealer also got the function to buy items from the player.
---
